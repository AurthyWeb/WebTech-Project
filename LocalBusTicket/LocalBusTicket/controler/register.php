        ...
        if($flag === true){
            if(!empty($firstname) && !empty($lastname) && !empty($email)&& !empty($password)&& !empty($confirmpassword)){
                if($password===$confirmpassword){
                    ...
                    $sql = "insert into driver(firstname,lastname, email, password) values('$firstname', '$lastname','$email','$password')";
...
<body>
    ...
    <form name="myForm" action="register.php" onsubmit="return isValidForm(this)" method="post" novalidate >
    <div align="center">
                    ...
                    <form name="myForm" action="register.php" onsubmit="return isValidForm(this)" method="post" novalidate>
                        <table>
                            ...
                            <tr align="center">
                                <td></td>
                                <td></td>
                                <td><input style="background-color:red;color:white;padding:8px 5px;text-transform:uppercase;border-radius:10%;margin-top:20px;" type="submit" name="submit" value="Register">
                                </td>
                            </tr>
    ...
    <div align="center">
    <h4>Already Have an Accout?<a style="color:red;text-decoration:none;text-transform:uppercase;font-weight:bold;" href="../controler/login.php">Login here</a></h4>
