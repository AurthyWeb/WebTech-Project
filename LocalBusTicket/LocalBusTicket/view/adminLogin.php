...
if($_SERVER['REQUEST_METHOD'] === "POST"){
    ...
    if($flag === true){
        ...
        if($row > 0){
            ...
            header('location:../view/roadInfo.php');
        ...
        <tr>
            <td>
                ...
                <fieldset>
                    ...
                    <!-- ---------------------------------------- -->
                    <form name="myForm" action="adminLogin.php" onsubmit="return isValid(this)" method="post" novalidate  >
                        <table>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td></td>
                                <td><p>Don't have an account?<a style="color:red;text-decoration:none;text-transform:uppercase;font-weight:bold;" href="../view/adminRegister.php">Register here</a></p></td>
                            </tr>
