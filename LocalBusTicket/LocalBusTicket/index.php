...
<form action="">
<h3 align="center">Click here to <a style="color:white;text-decoration:none;text-transform:uppercase;font-weight:bold;background:red;padding:6px 10px;border-radius:5px" href="controler/logout.php">Logout</a></h3>
</form>
